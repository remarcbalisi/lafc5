            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form action="{{route('store-new-user')}}" method="POST">
                        ...
                        <input type="text" id="{{$addr_type->name}}-street" type="text" class="form-control{{ $errors->has($addr_type->name . '-street') ? ' is-invalid' : '' }} input-lg" name="{{$addr_type->name . '-street'}}" placeholder="Street" required><br>
                        <input type="text" id="{{$addr_type->name}}-unit-no" type="text" class="form-control{{ $errors->has($addr_type->name . '-unit-no') ? ' is-invalid' : '' }} input-lg" name="{{$addr_type->name . '-unit-no'}}" placeholder="Unit no." required><br>
                        <input type="text" id="{{$addr_type->name}}-barangay" type="text" class="form-control{{ $errors->has($addr_type->name . '-barangay') ? ' is-invalid' : '' }} input-lg" name="{{$addr_type->name . '-barangay'}}" placeholder="Brgy." required><br>
                        <input type="text" id="{{$addr_type->name}}-city" type="text" class="form-control{{ $errors->has($addr_type->name . '-city') ? ' is-invalid' : '' }} input-lg" name="{{$addr_type->name . '-city'}}" placeholder="City" required><br>
                        <input type="text" id="{{$addr_type->name}}-postal-code" type="text" class="form-control{{ $errors->has($addr_type->name . '-postal-code') ? ' is-invalid' : '' }} input-lg" name="{{$addr_type->name . '-postal-code'}}" placeholder="Postal Code" required><br>
                        <input type="text" id="{{$addr_type->name}}-province" type="text" class="form-control{{ $errors->has($addr_type->name . '-province') ? ' is-invalid' : '' }} input-lg" name="{{$addr_type->name . '-province'}}" placeholder="Province" required><br>
                        @endforeach
