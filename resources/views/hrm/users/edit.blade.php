                    ...
                    <div class="col-md-8 col-md-offset-2">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form action="{{route('hrm-update-user', ['user_id'=>$user->id])}}" method="POST">
                                    {{ csrf_field() }}
                                    {{ method_field('PUT') }}
                                    ...
                                    <div class="form-group form-check">
                                        @foreach( $roles as $role )
                                            @if( $user->user_roles()->where('role_id','=',$role->id)->get()->count() > 0  )
                                                <input style="margin-left:-3%" type="checkbox" name="role[]" value="{{$role->id}}" class="form-check-input" onclick="toggleJobTitle(this)" checked>
